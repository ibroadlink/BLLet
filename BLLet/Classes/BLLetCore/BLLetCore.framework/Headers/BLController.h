...
/**
 ...
 @param pid pid
 */
- (void)cleanProfileCahe:(NSString *_Nullable)pid;
...
/// Reset device
/// @param deviceId Device did
- (BLBaseResult *_Nonnull)deviceReset:(NSString *_Nonnull)deviceId;


/// Reset remote device
/// @param deviceId Device did
- (BLBaseResult *_Nonnull)deviceResetOnServer:(NSString *_Nonnull)deviceId;
...
- (BLFirmwareVersionResult *_Nonnull)queryFirmwareVersionOnServer:(NSString *_Nonnull)deviceId;
...
/// Upgrade device firmware
/// @param deviceId  Device did
/// @param updateUrl New firmware download url
/// @param type 1.“FIRMWARM”  firmwarm update,  2. “PROFILE” profile update
- (BLBaseResult *_Nonnull)upgradeFirmwareOnServer:(NSString *_Nonnull)deviceId updateUrl:(NSString *_Nonnull)updateUrl type:(BLUpgradeFirmwareEnum)type;
/**
